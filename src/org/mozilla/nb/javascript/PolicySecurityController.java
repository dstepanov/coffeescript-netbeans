...
import org.mozilla.nb.classfile.ByteCode;
import org.mozilla.nb.classfile.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lorg/mozilla/nb/javascript/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE, 
                "org/mozilla/nb/javascript/Callable", "call", 
                "(" + callableCallSig);
