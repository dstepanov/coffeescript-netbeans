...
import org.mozilla.nb.classfile.*;
...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lorg/mozilla/nb/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lorg/mozilla/nb/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lorg/mozilla/nb/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName)
    {
        cfw.startMethod("<init>",
                        "(Lorg/mozilla/nb/javascript/ContextFactory;"
                        +"Lorg/mozilla/nb/javascript/Scriptable;)V",
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org/mozilla/nb/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org/mozilla/nb/javascript/JavaAdapter",
                      "runScript",
                      "(Lorg/mozilla/nb/javascript/Script;"
                      +")Lorg/mozilla/nb/javascript/Scriptable;");
                                       ...
                                       Class<?> returnType)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Lorg/mozilla/nb/javascript/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Lorg/mozilla/nb/javascript/Function;");
