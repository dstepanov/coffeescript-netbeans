...
import org.mozilla.nb.javascript.debug.Debugger;
...
public class Context
{
   ...
   // <netbeans>
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "org.mozilla.nb.javascript.tools.debugger.Main";
     ...
     *
     * @see org.mozilla.nb.javascript.ErrorReporter
     */
...
// </netbeans>
     ...
     * @see org.mozilla.nb.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (org.mozilla.nb.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.mozilla.nb.javascript.Script
     */
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "org.mozilla.nb.javascript.regexp.RegExpImpl");
            if (cl != null) {
