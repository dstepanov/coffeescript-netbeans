...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link org.mozilla.nb.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected org.mozilla.nb.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return org.mozilla.nb.javascript.xml.XMLLib.Factory.create(
                "org.mozilla.nb.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return org.mozilla.nb.javascript.xml.XMLLib.Factory.create(
                "org.mozilla.nb.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
